...
class Puzzle:
    ...
    def moveSpaceUp(self, spaceX, spaceY):
        self.puzzle[spaceX, spaceY], self.puzzle[spaceX-1,
                                                 spaceY] = self.puzzle[spaceX-1, spaceY], self.puzzle[spaceX, spaceY]
    ...
    def moveSpaceLeft(self, spaceX, spaceY):
        self.puzzle[spaceX, spaceY], self.puzzle[spaceX, spaceY -
                                                 1] = self.puzzle[spaceX, spaceY-1], self.puzzle[spaceX, spaceY]
    ...
    def printPuzzle(self, output_file):
        print('Generated %d-Puzzle (%d X %d) with approximated solution cost = %d' %
